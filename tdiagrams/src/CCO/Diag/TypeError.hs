...
ppError (RuntimeMismatch  x y) = text "Cannot run a program/interpreter/compiler in" >||< text x >||< text "on a platform/interpreter for" >||< text y
